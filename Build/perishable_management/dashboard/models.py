...
class Product(models.Model):
    ...
    quantity = models.FloatField(validators=[MinValueValidator(0.25), MaxValueValidator(200.0)], null=True)
    price = models.FloatField(validators=[MinValueValidator(0.25), MaxValueValidator(40000000.0)], null=True)
